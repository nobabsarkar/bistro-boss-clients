...
import { FaBook, FaBorderStyle, FaDollarSign, FaUsers } from "react-icons/fa";
...
const COLORS = ['#0088FE', '#00C49F', '#FFBB28', '#FF8042', 'red', 'pink'];
// const COLORS = ['#0088FE', '#00C49F', '#FFBB28', '#FF8042', '#FF8043',];
...
const AdminHome = () => {
    ...
    return (
        <div>
            ...
            <div className="stats shadow mt-10 flex justify-between">
                ...
                <div className="stat">
                    ...
                    <div className="stat-value">${states?.revenue.toFixed(2)}</div>
                ...
                <div className="stat">
                    <div className="stat-figure text-secondary">
                        <FaBorderStyle className="text-4xl"></FaBorderStyle>
                    </div>
                ...
                <div className="stat">
                    ...
                    <div className="stat-value">{states?.menuItes}</div>
                    <div className="stat-desc">↘︎ 90 (14%)</div>
                </div>
